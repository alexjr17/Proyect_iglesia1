    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active' => ['admin/miembros*'],
            'can'  => 'admin.miembros.index'
        ],
        [
            'text' => 'Ingresos',
            'url'  => 'admin/settings',
            'icon' => 'fas fa-fw fa-archive',
            'can'  => ['admin.diezmos.index', 'admin.ofrendas.index'],
            'active' => ['admin/diezmos*', 'admin/ofrendas*'],
            'submenu' => [
                [
                    'text' => 'Diezmos',
                    'icon'    => 'fas fa-fw fa-money-check-alt',
                    'route'  => 'admin.diezmos.index',
                    'can'  => 'admin.diezmos.index',
                    'active' => ['admin/diezmos*'],
                ],
                [
                    'text'    => 'Ofrendas',
                    'icon'    => 'fas fa-box-open fa-fw',
                    'route'     => 'admin.ofrendas.index',
                    'can'  => 'admin.ofrendas.index',
                    'active' => ['admin/ofrendas*'],
                ]
            ],
        ],
        [
            ...
            'can'  => ['admin.gastos.index', 'admin.propositos.index'],
            'submenu' => [
                [
                    'text' => 'Pagos',
                    'icon'    => 'fas fa-fw fa-money-check-alt',
                ...
                [
                    'text'    => 'Propositos',
                    'icon'    => 'fab fa-buffer fa-fw',
                    'route'     => 'admin.propositos.index',
                    'active' => ['admin/propositos*'],
                    'can'  => 'admin.propositos.index'
                ]
            ],
        ],
        [
